...
//
// Each article leads with `keyPoints` (short, scannable bullets) and keeps
// the fuller explanation in `body` — the page renders `body` inside a
// collapsed "read more" disclosure so mobile readers aren't hit with a wall
// of text up front but can still get the full research-backed detail.
    ...
    articles: [
      {
        ...
        keyPoints: [
          "Muscle and strength gains require consistently asking your body to do a bit more than it's used to.",
          "Progress can be small: +2.5-5 lbs every week or two, or one more rep before you add weight.",
          "Track your numbers (this app does it for you) — otherwise you're just guessing whether you're improving.",
        ],
        body: [
      ...
      },
      {
        ...
        keyPoints: [
          "Aim for roughly 10-20 hard sets per muscle group per week, spread across the week.",
          "Rep range matters less than effort — 5 to 30 reps per set all build muscle if taken close to failure.",
          "Heavy (3-6 reps) builds strength efficiently; moderate (8-15) is easiest to recover from and track; high reps (15-30+) suit smaller, joint-sensitive muscles.",
          "Most well-designed programs, including this app's defaults, mix all three rep ranges.",
        ],
        body: [
      ...
      },
      {
        ...
        keyPoints: [
          "Training a muscle twice a week tends to beat once a week at the same total volume.",
          "Full-body or upper/lower splits suit 3-4 training days a week; body-part splits suit 5-6.",
          "The best split is whichever one you can recover from and actually stick with for months.",
        ],
        body: [
      ...
      },
      {
        ...
        keyPoints: [
          "You don't need to hit complete failure — stopping 1-3 reps short works just as well for building muscle.",
          "Training to failure on every set mostly adds fatigue and injury risk, not extra results.",
          "Save true failure efforts for your last set, or safer isolation moves like curls and leg extensions.",
        ],
        body: [
      ...
      },
      {
        ...
        keyPoints: [
          "A deload is a planned week of reduced volume or intensity every 4-8 weeks.",
          "It lets joints, connective tissue, and your nervous system catch up before fatigue turns into injury or a plateau.",
          "Keep it simple: lighter weight, fewer sets, or a couple of extra rest days.",
        ],
        body: [
    ...
    articles: [
      {
        ...
        keyPoints: [
          "Weight change comes down to calories in vs. calories out — everything else is a smaller lever.",
          "Protein matters most for lifters: it rebuilds muscle and keeps you fuller per calorie.",
          "Meal timing and food quality matter far less than hitting your daily calorie and protein totals.",
        ],
        body: [
      ...
      },
      {
        ...
        keyPoints: [
          "Bulk: eat in a ~200-500 cal/day surplus, gaining roughly 0.25-0.5% of bodyweight per week.",
          "Cut: eat in a ~300-500 cal/day deficit, losing roughly 0.5-1% of bodyweight per week while keeping protein and training up.",
          "Going faster than these ranges usually adds fat (bulk) or costs muscle (cut) instead of improving results.",
          "Maintaining at your maintenance calories is a completely valid long-term choice.",
        ],
        body: [
      ...
      },
      {
        ...
        keyPoints: [
          "Aim for about 0.7-1g of protein per pound of bodyweight per day (1.6-2.2g per kg).",
          "More than that adds little extra benefit — protein needs have a ceiling, not a \"more is always better\" curve.",
          "Spreading it across 3-5 meals of 25-40g each is a practical way to hit your daily total.",
        ],
        body: [
      ...
      },
      {
        ...
        keyPoints: [
          "The \"30-minute anabolic window\" after training is largely a myth — the real window is much wider.",
          "Your total daily protein and calories matter far more than exact timing around a workout.",
          "Exception: if you train fasted, protein and carbs within a couple hours of training is a reasonable habit.",
        ],
        body: [
    ...
    articles: [
      {
        ...
        keyPoints: [
          "Sleep is when the actual muscle repair and growth from your training happens.",
          "Under 6-7 hours a night reduces muscle protein synthesis, blunts strength gains, raises appetite, and lowers testosterone.",
          "Poor sleep also increases soreness and measurably raises injury risk.",
          "Prioritizing 7-9 hours consistently likely beats any supplement or program tweak.",
        ],
        body: [
      ...
      },
      {
        ...
        keyPoints: [
          ...
          "Training the same muscle before it's recovered adds fatigue on top, not extra stimulus.",
          "Stalled progress, nagging joint pain, or persistent fatigue usually means you need more rest or a deload — not to push harder.",
        ],
        body: [
    ...
    articles: [
      {
        ...
        keyPoints: [
          "Creatine monohydrate: 3-5g/day, no loading or cycling needed, safe for long-term daily use.",
          "Protein powder is just a convenient way to hit your protein target — not magic, and unnecessary if food alone covers it.",
          "Caffeine (roughly 3-6mg/kg, 30-60 min pre-workout) reliably boosts strength, endurance, and focus, though tolerance builds with regular use.",
        ],
        body: [
      ...
      },
      {
        ...
        keyPoints: [
          "BCAAs add little if you already eat enough total protein.",
          "Over-the-counter fat burners and \"testosterone boosters\" are almost universally underdosed or unproven.",
          "Pre-workouts are mostly just caffeine with a marketing story.",
          "Be skeptical of any supplement whose big claims aren't backed by multiple independent studies.",
        ],
        body: [
    ...
    articles: [
      {
        ...
        keyPoints: [
          "This section is education only — not instructions, dosing, cycling, or sourcing guidance.",
          "Most people training naturally haven't come close to their genetic potential yet.",
          "Any decision about these substances should involve a doctor, not a fitness app.",
        ],
        body: [
      ...
      },
      {
        ...
        keyPoints: [
          "Synthetic testosterone that speeds muscle growth and recovery well beyond natural limits.",
          "Controlled substances in most countries, including the U.S. — legal only with a prescription for specific medical conditions.",
          "Real risks: suppressed natural testosterone (sometimes permanent), cardiovascular strain, liver stress, mood/psychiatric effects, and infertility risk in men.",
          "Unregulated sourcing adds risk from contaminated, mislabeled, or counterfeit products.",
        ],
        body: [
      ...
      },
      {
        ...
        keyPoints: [
          "No SARM is approved for human use anywhere — every one sold as a supplement is an unregulated research chemical.",
          "Studies show many SARM and peptide products don't contain what the label claims, sometimes including undisclosed steroids.",
          "\"Not FDA-approved\" means there's no reliable safety or dosing data — not that it's a gentler alternative.",
        ],
        body: [
    ...
    articles: [
      {
        ...
        title: "In the gym",
        keyPoints: [
          "Program hopping is one of the biggest things that stalls beginner progress — consistency beats the \"best\" program.",
          "Ego lifting (too much weight, bad form) raises injury risk and often trains the wrong muscles.",
          "Not tracking your workouts means you're guessing whether you're actually progressing.",
          "Skipping warm-up sets raises injury risk and often makes your first working set worse.",
        ],
        body: [
      ...
      },
      {
        ...
        keyPoints: [
          "Undereating protein while training hard leaves your body without raw material to build with.",
          "Chronic undersleeping quietly sabotages gym progress just as much as anything you do in the gym.",
          "All-or-nothing thinking turns one missed workout into a wasted week — consistency over months matters more.",
          "Comparing week-one progress to someone else's years of training (or an edited photo) is a fast way to get discouraged for no reason.",
        ],
        body: [
